...
const Slide = ({ slide, index, current, handleSlideClick }: SlideProps) => {
  ...
  return (
    <div className="[perspective:1200px] [transform-style:preserve-3d] ">
      ...
      >
        <div
          className="absolute top-0 left-0 w-full h-full bg-background rounded-2xl overflow-hidden transition-all duration-150 ease-out"
          style={{
            transform:
              current === index
...
export function Carousel({ slides }: CarouselProps) {
  ...
  return (
    ...
    >
      {/* The track ignores pointer events, so it won't eat clicks over the controls */}
      <ul
        className="absolute pointer-events-none flex mx-[-4vmin] transition-transform duration-1000 ease-in-out"
        style={{
      ...
      {/* Controls are above and always clickable */}
      <div className="absolute z-50 flex justify-center w-full top-[calc(100%+1rem)]">
        <CarouselControl
          type="previous"
